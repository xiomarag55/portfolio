...
export class Hero implements OnInit, OnDestroy {
  typedText = '';
  private roles = ['Full Stack Developer', 'Angular Expert', 'Node.js Engineer', 'Cloud Architect', 'UI/UX Enthusiast'];
  private roleIndex = 0;
  private charIndex = 0;
